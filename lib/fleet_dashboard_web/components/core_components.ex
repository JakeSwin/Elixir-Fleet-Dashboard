defmodule FleetDashboardWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FleetDashboardWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FleetDashboardWeb.Gettext, "errors", msg, opts)
    end
  end
